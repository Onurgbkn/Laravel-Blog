...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ request()->routeIs('admincontacts*') ? 'active' : '' }}">
                <a class="nav-link py-3" href="{{route('admincontacts')}}">
            ...
            <li class="nav-item {{ request()->routeIs('resetpassw*') ? 'active' : '' }}">
